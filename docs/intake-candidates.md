...
_Auto-synced 2026-07-30 from `docs/intake-state.json`, `registry/index.json`, and GitHub (via `gh`). Edit `intake-state.json` to add candidates; run `python scripts/sync-intake-candidates.py` to refresh._
...
| [`cptpiepmatz/nu_plugin_highlight`](https://github.com/cptpiepmatz/nu-plugin-highlight) | plugin | v1.4.15 | linux x64/arm64, macOS arm64, Windows x64 (no intel mac) | live (ci-built asset) — ci-built via numan-plugins |
| [`fdncred/nu_plugin_regex`](https://github.com/fdncred/nu_plugin_regex) | plugin | v0.22.0 | linux x64/arm64, macOS arm64, Windows x64 (no intel mac) | live (ci-built asset) — ci-built via numan-plugins |
...
| [`FMotalleb/nu_plugin_port_extension`](https://github.com/FMotalleb/nu_plugin_port_extension) | plugin | v0.113.1 | linux x64/arm64, macOS x64/arm64, Windows x64 | live (ci-built asset) — ci-built via numan-plugins Wave 1 |
