...
Generated: `2026-08-07T00:34:20Z` · Index `updated_at`: `2026-08-07T00:34:20Z` · `registry_revision`: `seed-2026-07-02`
...
- **39** packages total
- By type: `completion` 2, `module` 7, `plugin` 26, `script` 4
- Latest version Nu band: `0.114` 18, `0.113` 4, `0.112` 1, `other` 6, `*` 10
...
| `SuaveIV/nu_script_hnews` | script | 0.1.0-6cd8aef | `*` | * | — | mirror | 1 |
