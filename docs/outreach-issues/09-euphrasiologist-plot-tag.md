...
For the [Numan](https://github.com/tonythethompson/numan) official registry and [numan-plugins](https://github.com/tonythethompson/numan-plugins) CI builds I need an immutable **tag + commit**. Without that I either stay off-catalog or invent a commit-snapshot policy (something I'd rather not do without maintainer buy-in).
